...
namespace MovieServiceFinalProject
{
    ...
    public class ScienceFictionMovie
    {
       private string Title { get; set; }

        public void ScienceFiction(ListBox lb)
        {
            ...
            try
            {
                ...
                sqlsel = "select MovieName from Movie,Info where info.FilmCategoryID=4 and Movie.FilmCategoryID=4 ";
            ...
            //        command.CommandText = "select MovieName from Movie,Info where info.FilmCategoryID=4 and Movie.FilmCategoryID=4 ";
